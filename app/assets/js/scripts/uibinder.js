  ...
  setTimeout(() => {
    $("#loadingContainer").fadeOut(250, () => {
      ...
      setOverlayContent(
        ...
        "Aucune connexion n’a pu être établie avec nos serveurs pour télécharger l’index de distribution. Aucune copie locale n’était disponible pour le chargement. <br><br>L’index de distribution est un fichier essentiel qui fournit les dernières informations du serveur. Le launcher ne peut pas démarrer sans lui. Assurez-vous d’être connecté à Internet et relancez l’application.",
        "Fermer"
      );
      setOverlayHandler(() => {
  ...
  if (selectedAcc != null) {
    ...
    if (!val) {
      ...
      setOverlayContent(
        ...
        `Nous n’avons pas pu actualiser l’ouverture de session pour <strong>${
