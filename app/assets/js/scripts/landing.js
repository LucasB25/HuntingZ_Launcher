...
function dlAsync(login = true) {
      ...
      if (login && allGood) {
        ...
        const gameErrorListener = function (data) {
          ...
          if (
            ...
            loggerLaunchSuite.error(
              "Le lancement du jeu a échoué, le fichier principal, LaunchWrapper n'a pas été téléchargé correctement."
            );
            showLaunchFailure(
        ...
        try {
          ...
          showLaunchFailure(
            ...
            "Veuillez vérifier la console (CTRL + Shift + i) pour plus de détails."
          );
        }
      }
  ...
  refreshDistributionIndex(
    ...
    (err) => {
      loggerLaunchSuite.log(
        "Erreur lors de la récupération d'une nouvelle copie de l'index de distribution.",
        err
      );
      refreshDistributionIndex(
        false,
        ...
        (err) => {
          ...
          if (DistroManager.getDistribution() == null) {
            showLaunchFailure(
              "Erreur Fatale",
              "Impossible de charger une copie de l'index de distribution. Consultez la console (CTRL + Shift + i) pour plus de détails."
            );
